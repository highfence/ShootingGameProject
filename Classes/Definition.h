...
namespace ENEMY
{
	enum ENEMY_TYPE
	{
		ENEMY_ITEM, ITEM, ENEMY_ZACO, ENEMY_HAND_SHOT, ENEMY_TYPE_NUM
	};
	...
	enum MISSILE_TYPE
	{
		NONE, STRAIGHT_FIRE, ACCELERATE_FIRE, CIRCLE_FIRE, MISSILE_TYPE_NUM
	};

	enum FIRE_TYPE
	{
		NORMAL_FIRE, AIMED_FIRE, N_WAY_FIRE, MULTI_FIRE, FIRE_TYPE_NUM
	};
