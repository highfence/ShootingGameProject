...
namespace ENEMY
{
	...
	enum CREATE_OPTION
	{
		ENEMY_ITEM_TRUE, ENEMY_ITEM_FALSE, ITEM_CREATE, ENEMY_HAND_SHOT_CREATE, ENEMY_MINE_DIAGONAL, CREATE_OPTION_NUM
	};
	
	enum FIRE_OPTION
	{
		NO_FIRE, FIRE_FRONT, FIRE_AIMED, MINE_AIMED, N_WAY_FIRE_OPTION, N_WAY_FIRE_TO_PLAYER, MULTI_FIRE_OPTION, ROTATE_FIRE_OPTION, FIRE_OPTION_NUM
	};
